...
//			conn = DriverManager.getConnection(mySqlUrl, id, pwd);
			//servletcontext 데이터 보관소에 저장되어있는 Connection 객체를 꺼내 슴
			...
			while(rs.next()) {
				members.add(new Member()
										...
										//.setPassword(rs.getString("PWD")) //브라우저 상에서 관리 목적으로 패스워드를 presenting 하려면 MemberListServlet.java파일과  MemberList.jsp 파일에 패스워드가 보이겠금 세팅 해줘야 한다. 
